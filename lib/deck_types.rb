DeckTypes = {
  ...
  "arena-promo"     => { category: "deck",     format: "?",          name: "Arena Promotional Deck",         sizes: [[60]]},
  "arena-starter"   => { category: "deck",     format: "?",          name: "Arena Starter Deck",             sizes: [[60], [60, 9]] },
  "box"             => { category: "box",      format: nil,          name: "Box Set" }, # Any size
  "brawl"           => { category: "deck",     format: "brawl",      name: "Brawl Deck",                     sizes: [[59, 0, 1]], },
  "challenger"      => { category: "deck",     format: "?",          name: "Challenger Deck",                sizes: [[60, 15]] },
  "clash"           => { category: "deck",     format: "?",          name: "Clash Pack",                     sizes: [[60, 0], [60, 15]] },
  ...
  "game-night"      => { category: "deck",     format: "?",          name: "Game Night Deck",                sizes: [[60]] },
  ...
  "mtgo"            => { category: "deck",     format: "?",          name: "MTGO Theme Deck",                sizes: [[60, 0], [60, 15]], },
  ...
  "premium"         => { category: "deck",     format: "?",          name: "Premium Deck",                   sizes: [[60]] },
  "pt"              => { category: "deck",     format: "?",          name: "Pro Tour Deck",                  sizes: [[60, 15], [62, 15]] },
  ...
  "theme-61"        => { category: "deck",     format: "?",          name: "Theme Deck",                     sizes: [[61]] },
  "theme-62"        => { category: "deck",     format: "?",          name: "Theme Deck",                     sizes: [[62]] },
