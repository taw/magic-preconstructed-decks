DeckTypes = {
  ...
  "cmd-pc"            => { category: "deck",     format: "planechase commander", name: "Commander Deck",                 sizes: [[99, 10, 1], [98, 10, 2]] },
  "cmd"               => { category: "deck",     format: "commander",            name: "Commander Deck",                 sizes: [[99, 0, 1], [98, 0, 2]] },
  ...
  "starter-std"       => { category: "deck",     format: "casual standard",      name: "Starter Deck",                   sizes: [[30], [33]]},
